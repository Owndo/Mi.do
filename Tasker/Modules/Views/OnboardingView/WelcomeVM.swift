...
//    var description3: LocalizedStringKey = "Everything stays in your hands\nand never leaves your device.\nPlan your life with Mi.dō!"
    ...
    // New value
    var description1: LocalizedStringKey = "Life isn’t a goal, it's a journey. We’re here to walk it with you."
    var description2: LocalizedStringKey = "Create tasks, reminders, notes or voice recordings - we’ll save and gently remind you when it truly matters."
    var description3: LocalizedStringKey = "Everything stays in your hands and never leaves your device. Your life. Your data."
