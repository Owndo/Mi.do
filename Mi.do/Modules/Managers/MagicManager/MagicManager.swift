...
public final class MagicManager {
    ...
    //MARK: - Create magic manager
    public static func createMagicManager(dateManager: DateManagerProtocol) -> MagicManager {
        MagicManager(dateManager: dateManager)
    }
    ...
    //MARK: Date logic
    public func extractDateTime(from text: String) -> DateTimeResult? {
...
extension MagicManager {
    ...
    public func extractTaskTitleWithNames(from text: String) -> String {
